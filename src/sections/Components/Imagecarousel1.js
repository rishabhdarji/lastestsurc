...
const Imagecarousel1 = () => {
    let box1 = document.querySelector('.product-container1');
...
var colorindex=0;
    return (
        <div  className="product-carousel1">
            <button className="pre-btn1" style={{marginLeft:"290px"}}  onClick={()=>btnpressprev1()}><p>&lt;</p></button>
            <button className="next-btn1" style={{marginRight:"320px"}} onClick={()=>btnpressnext1()}><p>&gt;</p></button>

        <div style={{marginLeft:"370px"}}>
            <div className="product-container1" style={{width:"1100px"}}>
            {data.map((name)=>
                            <div style={{width: '575px', marginRight: '30px',float:"left"}}>
                                <div className="velaProBlock grid" data-price="1,600.00"  onClick={()=>handleProceed(name.id)}>
