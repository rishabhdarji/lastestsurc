...
const Imagecarousel2 = () => {
    let box2 = document.querySelector('.product-container2');
...
var colorindex=0;
    return (
        <div className="product-carousel2">
            <button className="pre-btn2" style={{marginLeft:"290px"}}  onClick={btnpressprev2}><p>&lt;</p></button>
            <button className="next-btn"  style={{marginRight:"320px"}} onClick={btnpressnext2}><p>&gt;</p></button>

        <div style={{marginLeft:"370px"}}>
            <div className="product-container2" style={{width:"1100px"}}>
            {data.map((name)=>
